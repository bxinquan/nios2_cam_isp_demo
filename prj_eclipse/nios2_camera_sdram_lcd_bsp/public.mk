...
SOPCINFO_FILE := C:/work/fpga/nios2_camera_sdram_lcd/prj_qsys/nios2_camera_sdram_lcd.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios2_camera_sdram_lcd
SOPC_NAME := nios2_camera_sdram_lcd
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2005248
SOPC_SYSID_FLAG += --sidp=0x2005248
ELF_PATCH_FLAG  += --sidp 0x2005248

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1621684465
SOPC_SYSID_FLAG += --timestamp=1621684465
ELF_PATCH_FLAG  += --timestamp 1621684465
