#
# avalon_lcd_rgb_controller_sw.tcl
#

# Create a new driver
create_driver avalon_lcd_rgb_controller_driver

# Associate it with some hardware known as "avalon_lcd_rgb_controller"
set_sw_property hw_class_name avalon_lcd_rgb_controller
...
# Include files
add_sw_property include_source inc/avalon_lcd_rgb_controller_regs.h
