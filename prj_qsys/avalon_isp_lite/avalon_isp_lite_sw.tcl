#
# avalon_isp_lite_sw.tcl
#

# Create a new driver
create_driver avalon_isp_lite_driver

# Associate it with some hardware known as "avalon_isp_lite"
set_sw_property hw_class_name avalon_isp_lite
...
# Include files
add_sw_property include_source inc/avalon_isp_lite_regs.h
add_sw_property include_source inc/avalon_isp_algo_2a.h
add_sw_property include_source src/avalon_isp_algo_2a.c
