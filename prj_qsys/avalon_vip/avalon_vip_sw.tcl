...
# Create a new driver
create_driver avalon_vip_driver

# Associate it with some hardware known as "avalon_vip"
set_sw_property hw_class_name avalon_vip
...
# Include files
add_sw_property include_source inc/avalon_vip_regs.h
